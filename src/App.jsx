...
const MODELS = [
  { id: "chatgpt", label: "ChatGPT", sublabel: "gpt-4.1", color: "#10a37f", bg: "#e6f7f3", textColor: "#0a5c44" },
  { id: "mistral", label: "Mistral", sublabel: "mistral-large-latest", color: "#FF7000", bg: "#fff0e6", textColor: "#a34500" },
